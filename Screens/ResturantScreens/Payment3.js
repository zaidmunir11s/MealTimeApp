 ...
 start={{ x: 1, y: 0.1 }}
  ...
  >
      ...
      <View style={{flexDirection:"column",alignSelf:'center'  
          ...
          <TextInput
            placeholder='Enter Card No or Scan' 
        ...
        <Image
            style={{resizeMode:'contain',width:RFValue(30),height:RFValue(30),marginLeft:RFValue(0)  
...
>
              ...
              <TouchableOpacity  
               onPress={()=>{this.props.navigation.navigate('SellerPayment4')}}
